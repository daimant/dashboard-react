...
const dictDescriptionAbout: { [key: string]: string } = {
  ...
  id10: 'Динамика по среднему времени выполнения запроса. При расчёте среднего времени не учитываются регламентные работы, заявки на ремонт\\установки нового РМ и установки Этран.',
