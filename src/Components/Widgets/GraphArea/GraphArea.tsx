...
const dictDescriptionAbout: { [key: string]: string } = {
  'Назначение заявок': 'Отображает динамику назначения запросов, без привязки к фильтрам.',
  'Назначение запросов': 'Отображает динамику назначения запросов, без привязки к фильтрам.',
  'Установка ПО': 'Отображает динамику по запросам на «установку ПО», без привязки к фильтрам.',
};
