            ...
            <TableRow component={'tr'}>
              ...
              <TableCell className={classes.cell}>
                <div className={switchSDAWHIT ? classes.tableHeadWhenSwitchedSHAWHIT : classes.tableHead}>
                  {value}
                  <AboutWidget
                    description={'КПК услуг за период по выбранному подразделению. Для просмотра графика необходимо ' +
                    'выбрать услугу. Исключение «Контакт-центр», показатель услуги не привязан к выбранному подразделению.'}/>
                </div>
              </TableCell>
            </TableRow>
          </TableHead>
